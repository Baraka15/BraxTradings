...
cat << 'INNER_EOF' > app/src/main/java/com/example/ui/components/OrderBookComponent.kt
...
import com.example.domain.trading.Quote
import com.example.ui.theme.*
import java.util.Locale

@Composable
fun OrderBookComponent(quote: Quote?, modifier: Modifier = Modifier) {
    if (quote == null) return

    val basePrice = quote.lastPrice
    val bids = (1..5).map { i ->
